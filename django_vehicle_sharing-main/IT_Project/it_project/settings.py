...
SECRET_KEY = 'django-insecure-l0q40jszt6q4^krwn5alj%m-(dkf=ja-l%2@y=(ahb0wzmq8@j'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'locations.context_processors.message_processor',
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'locations:index'
